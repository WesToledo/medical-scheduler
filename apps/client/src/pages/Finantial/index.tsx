...
export default function FinantialPage() {
  ...
  const DataTable = () => {
    ...
    const data: MUIDataTableProps['data'] = [
      {
        id: 23,
        patient: 'Paciente',
        payment_day: format(new Date(), 'dd/MM/yyyy'),
    ...
    return <DatatableBase columns={columns} data={data} options={options} onClickAddButton={onOpen} />;
  };
